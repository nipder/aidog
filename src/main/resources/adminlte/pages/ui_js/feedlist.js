/**
 * Created by 03010335 on 2020/6/8.
 */
var viewdata;
var checkdogid;
$(function () {
...
function detailFeedTimeInfo(id) {
    $("#feedid").html(id);
    $("#feedTimeDiv").modal({
        remote: 'feedtimemodal.html'

    });
    $("#feedTimeDiv").modal('show');
    //Bootstrap v3
    $("#feedTimeDiv").on("hidden.bs.modal", function() {
        $(this).removeData("bs.modal");
    });
}

function dosingvideoInfo(id){
	$("#feedid").html(id);
	$("#feedVideoDiv").modal({
        remote: 'feedvideosmodal.html'
    });
    $("#feedVideoDiv").modal('show');
    //Bootstrap v3
    $("#feedVideoDiv").on("hidden.bs.modal", function() {
        $(this).removeData("bs.modal");
    });
}
